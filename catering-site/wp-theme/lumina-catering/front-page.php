...
<!-- Hero -->
  <section id="home" class="hero">
    <div class="hero-bg">
      <img src="<?php echo lumina_img('hero-bar.jpg'); ?>" alt="Premium bar and catering service in Hong Kong">
    </div>
    <div class="hero-content">
      ...
      <div class="hero-cta">
        <a href="#contact" class="btn btn-accent" data-i18n="hero.cta1">Plan Your Event</a>
        <a href="#services" class="btn btn-outline" data-i18n="hero.cta2">Explore Services</a>
      </div>
    ...
    <div class="container">
      <div class="about-grid reveal">
        <div class="about-image">
          <img src="<?php echo lumina_img('gourmet-canapes.jpg'); ?>" alt="Gourmet catering at Hong Kong event">
        </div>
        <div>
      ...
      <div class="services-grid">
        <article class="service-card featured reveal">
          <div class="service-card-image">
            <img src="<?php echo lumina_img('corporate-gala.jpg'); ?>" alt="Corporate event catering">
          </div>
          <div class="service-card-body">
            ...
            <a href="#contact" class="service-link" data-i18n="services.link">Learn More</a>
          </div>
        </article>
        <article class="service-card reveal">
          <div class="service-card-image">
            <img src="<?php echo lumina_img('wedding-catering.jpg'); ?>" alt="Wedding catering">
          </div>
          <div class="service-card-body">
        ...
        <article class="service-card reveal">
          <div class="service-card-image">
            <img src="<?php echo lumina_img('garden-party.jpg'); ?>" alt="Private celebration catering">
          </div>
          <div class="service-card-body">
        ...
        <article class="service-card reveal">
          <div class="service-card-image">
            <img src="<?php echo lumina_img('bar-service.jpg'); ?>" alt="Bar and beverage service">
          </div>
          <div class="service-card-body">
        ...
        <article class="service-card reveal">
          <div class="service-card-image">
            <img src="<?php echo lumina_img('full-service.jpg'); ?>" alt="Full service catering">
          </div>
          <div class="service-card-body">
  ...
  <section id="gallery" class="section" style="background: var(--color-surface);">
    <div class="container">
      ...
      <div class="gallery-grid reveal">
        <div class="gallery-item"><img src="<?php echo lumina_img('rooftop-wedding.jpg'); ?>" alt="Rooftop wedding catering"></div>
        <div class="gallery-item"><img src="<?php echo lumina_img('cocktail-reception.jpg'); ?>" alt="Cocktail reception"></div>
        <div class="gallery-item"><img src="<?php echo lumina_img('dessert-table.jpg'); ?>" alt="Dessert table"></div>
        <div class="gallery-item"><img src="<?php echo lumina_img('buffet-station.jpg'); ?>" alt="Buffet station"></div>
        <div class="gallery-item"><img src="<?php echo lumina_img('charity-gala.jpg'); ?>" alt="Charity gala dinner"></div>
      </div>
    </div>
  </section>
