...
<section class="page-hero">
    <div class="page-hero-bg">
      <img src="<?php echo lumina_img('buffet-station.jpg'); ?>" alt="Gourmet catering menu Hong Kong">
    </div>
  ...
  <section class="section" style="padding-bottom: 2rem;">
    <div class="container">
      <div class="food-showcase reveal">
        <div class="food-showcase-item"><img src="<?php echo lumina_img('gourmet-canapes.jpg'); ?>" alt="Wedding banquet dishes"></div>
        <div class="food-showcase-item"><img src="<?php echo lumina_img('dessert-table.jpg'); ?>" alt="Fresh seafood platter"></div>
        <div class="food-showcase-item"><img src="<?php echo lumina_img('wedding-catering.jpg'); ?>" alt="Dessert selection"></div>
        <div class="food-showcase-item"><img src="<?php echo lumina_img('cocktail-reception.jpg'); ?>" alt="Cocktail canapés"></div>
        <div class="food-showcase-item"><img src="<?php echo lumina_img('full-service.jpg'); ?>" alt="Corporate buffet"></div>
      </div>
    </div>
  </section>
      ...
      <div class="menu-category active" data-category="all">
        <div class="menu-grid">
          <article class="menu-item reveal" data-cat="canapes">
            <div class="menu-item-image"><img src="<?php echo lumina_img('gourmet-canapes.jpg'); ?>" alt="Har Gow and Siu Mai"></div>
          ...
          <article class="menu-item reveal" data-cat="canapes">
            <div class="menu-item-image"><img src="<?php echo lumina_img('cocktail-reception.jpg'); ?>" alt="Char siu bao sliders"></div>
            <div class="menu-item-body">
          ...
          <article class="menu-item reveal" data-cat="canapes">
            <div class="menu-item-image"><img src="<?php echo lumina_img('buffet-station.jpg'); ?>" alt="Smoked salmon blinis"></div>
            <div class="menu-item-body">
          ...
          <article class="menu-item reveal" data-cat="chinese">
            <div class="menu-item-image"><img src="<?php echo lumina_img('rooftop-wedding.jpg'); ?>" alt="Braised abalone"></div>
            <div class="menu-item-body">
          ...
          <article class="menu-item reveal" data-cat="chinese">
            <div class="menu-item-image"><img src="<?php echo lumina_img('corporate-gala.jpg'); ?>" alt="Roast suckling pig"></div>
            <div class="menu-item-body">
          ...
          <article class="menu-item reveal" data-cat="chinese">
            <div class="menu-item-image"><img src="<?php echo lumina_img('garden-party.jpg'); ?>" alt="Lobster noodles"></div>
            <div class="menu-item-body">
          ...
          <article class="menu-item reveal" data-cat="western">
            <div class="menu-item-image"><img src="<?php echo lumina_img('full-service.jpg'); ?>" alt="Wagyu beef"></div>
            <div class="menu-item-body">
          ...
          <article class="menu-item reveal" data-cat="western">
            <div class="menu-item-image"><img src="<?php echo lumina_img('wedding-catering.jpg'); ?>" alt="Sea bass"></div>
            <div class="menu-item-body">
          ...
          <article class="menu-item reveal" data-cat="desserts">
            <div class="menu-item-image"><img src="<?php echo lumina_img('dessert-table.jpg'); ?>" alt="Mango pomelo sago"></div>
            <div class="menu-item-body">
          ...
          <article class="menu-item reveal" data-cat="desserts">
            <div class="menu-item-image"><img src="<?php echo lumina_img('charity-gala.jpg'); ?>" alt="Egg tarts"></div>
            <div class="menu-item-body">
          ...
          <article class="menu-item reveal" data-cat="desserts">
            <div class="menu-item-image"><img src="<?php echo lumina_img('product-launch.jpg'); ?>" alt="Fruit platter"></div>
            <div class="menu-item-body">
          ...
          <article class="menu-item reveal" data-cat="beverages">
            <div class="menu-item-image"><img src="<?php echo lumina_img('bar-service.jpg'); ?>" alt="Gin and tonic bar"></div>
            <div class="menu-item-body">
          ...
          <article class="menu-item reveal" data-cat="beverages">
            <div class="menu-item-image"><img src="<?php echo lumina_img('hero-bar.jpg'); ?>" alt="Champagne selection"></div>
            <div class="menu-item-body">
          ...
          <article class="menu-item reveal" data-cat="beverages">
            <div class="menu-item-image"><img src="<?php echo lumina_img('private-events.jpg'); ?>" alt="Mocktail programme"></div>
            <div class="menu-item-body">
